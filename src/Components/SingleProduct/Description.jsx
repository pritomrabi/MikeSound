            ...
            <table className="w-full border border-gray-200 dark:border-gray-700 rounded-lg">
              <tbody>
                {[
                  ...
                  ["Power Type", product.power_type || "-"],
                  ["Connector Type", product.connector_type || "-"],
                  ["Warranty", product.warranty_period ? `${product.warranty_period} months` : "-"],
                ].map(([key, value], idx) => (
        ...
        {/* {activeTab === "review" && (
          <div className="mt-4 sm:mt-6 font-Nunito-font">
            ...
            <form className="space-y-3 sm:space-y-4">
              <div className="flex gap-1 text-xl sm:text-2xl text-gray-400 cursor-pointer">★ ★ ★ ★ ★</div>
              <input
                type="text"
                placeholder="Name"
