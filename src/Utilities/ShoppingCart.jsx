...
const ShoppingCart = ({ setShop }) => {
  ...
  return (
    <div className="absolute w-full top-0 left-0 flex transition-all duration-500 h-screen">
      ...
      <div className="fixed right-0 text-black bg-white dark:bg-[#1a1a1a] xl:w-[35%] lg:w-[45%] md:w-[65%] sm:w-[60%] w-[85%] h-full items-center top-0 bottom-2 shadow-md rounded-l-2xl px-1 sm:px-4 md:px-8 py-4 z-50">
        <p
          onClick={() => setShop(false)}
                  ...
                  <li key={item.id} className="flex items-center gap-4 pb-3 mr-5">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 border-gray-300">
                        <div className="flex border rounded border-gray-300 w-fit dark:text-white">
                          <button
